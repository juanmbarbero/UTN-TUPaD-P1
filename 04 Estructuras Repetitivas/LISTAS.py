...
mis_favoritos = ["familia", "amigos", "futbol", "perros", "mate"]
...
animales = ["perro", "gato", "vaca", "pez"]"""

animales = ["perro", "gato", "vaca", "leon"]
...
#Este programa lo que hace es sacar el número mas alto entre todos los de la lista, en este caso el 22,
#e imprime solo los restantes.
